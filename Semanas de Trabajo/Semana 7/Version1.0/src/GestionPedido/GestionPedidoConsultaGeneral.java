...
import GestionEnsamblador.GestionEnsambladorConsultaGeneral;
 ...
 * @author enzun
 */
public class GestionPedidoConsultaGeneral extends javax.swing.JFrame {

    /**
     * Creates new form FormDashboard
     */
    public GestionPedidoConsultaGeneral() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel18.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Reporte.png"))); // NOI18N
        ...
        jPanel4.add(jLabel18, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 490, -1, -1));
 ...
 try{
            ...
            String sql="SELECT idPedido ,idVerificador ,idEnsambladora, codigosuministro, item , cantidad, fechaCreacion, fechaFinalizacion FROM Pedido";
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        ...
        try {
            URL archivo=this.getClass().getResource("/Reportes/GeneralPedido.jasper");
            ...
            Logger.getLogger(GestionPedidoConsultaGeneral.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionPedidoConsultaGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionPedidoConsultaGeneral().setVisible(true);
            }
        });
    }
