...
import GestionSuministro.GestionSuministroConsultaGeneral;
 ...
 * @author enzun
 */
public class GestionVerificadorConsultaGeneral extends javax.swing.JFrame {

    /**
     * Creates new form FormDashboard
     */
    public GestionVerificadorConsultaGeneral() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtbEnsamblador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Verificador", "Id Diseño", "Cédula ", "Aprobación"
            }
        ) {
 ...
 try{
            ...
            String sql="SELECT idVerificador ,idDiseno ,cedula, aprobacion FROM Verificador";
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        ...
        try {
            URL archivo=this.getClass().getResource("/Reportes/GeneralVerificador.jasper");
            ...
            Logger.getLogger(GestionVerificadorConsultaGeneral.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionVerificadorConsultaGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionVerificadorConsultaGeneral().setVisible(true);
            }
        });
    }
