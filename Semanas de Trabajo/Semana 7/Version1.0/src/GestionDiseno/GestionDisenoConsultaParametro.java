 ...
 * @author enzun
 */
public class GestionDisenoConsultaParametro extends javax.swing.JFrame {
    ...
    public GestionDisenoConsultaParametro() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 490, -1, -1));
        ...
        jPanel4.add(txtParametro, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 190, 110, -1));
        ...
        cbxParametro.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "ID Diseño", "Dimensiones", "Batería", "Procesador", "Pin Carga", "Pin Audífono", "Sistema Operativo", "Cámara Frontal", "Cámara Posterior", "Giróscopio", "Acelerómetro", "Detalles" }));
        cbxParametro.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                cbxParametroActionPerformed(evt);
            }
        });
        ...
        jtbEnsamblador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID Diseño", "Dimensiones", "Batería", "Procesador", "Pin Carga", "Pin Audífono", "Sistema Operativo", "Cámara Frontal", "Cámara Posterior", "Giroscopio", "Acelerómetro", "Detalles"
            }
        ));
        jScrollPane1.setViewportView(jtbEnsamblador);

        jPanel4.add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 230, 770, 260));
    ...
    private void jLabel12MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel12MouseClicked
        ...
        try
        {
            ...
            jtbEnsamblador.setModel(modelo);
             ...
             String aux = null;
            aux = "SELECT idDiseno, dimenciones ,bateria ,procesador ,pinCarga ,pinAudifono ,sistemaOperativo ,camaraFrontal ,camaraPosterior ,giroscopio ,acelerometro, detalles  FROM Diseno WHERE Diseno.";
          ...
          modelo.addColumn("ID Diseno");
            modelo.addColumn("Dimensiones");
            modelo.addColumn("BaterÍa");
            modelo.addColumn("Procesador");
            modelo.addColumn("PinCarga");
            modelo.addColumn("PinAudífono");
            modelo.addColumn("SistemaOperativo");
            modelo.addColumn("CámaraFrontal");
            modelo.addColumn("CámaraPosterior");
            modelo.addColumn("Giroscopio");
            modelo.addColumn("Acelerómetro");
    ...
    private void cbxParametroActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cbxParametroActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_cbxParametroActionPerformed
    ...
    private void jLabel17MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel17MouseClicked
        ...
        {
            listadiseno disenos = new listadiseno(jtbEnsamblador.getValueAt(i,0).toString(),jtbEnsamblador.getValueAt(i,1).toString(),jtbEnsamblador.getValueAt(i,2).toString(),jtbEnsamblador.getValueAt(i,3).toString(),jtbEnsamblador.getValueAt(i,4).toString(),jtbEnsamblador.getValueAt(i,6).toString(),jtbEnsamblador.getValueAt(i,11).toString());
            lista.add(disenos);
        }
        try {
            JasperReport reporte = (JasperReport) JRLoader.loadObject("ParametroDiseno.jasper");
            ...
            Logger.getLogger(GestionDisenoConsultaParametro.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionDisenoConsultaParametro.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionDisenoConsultaParametro().setVisible(true);
            }
        });
    }
