...
import Form.*;
import GestionEmpleado.GestionEmpleadoConsultaGeneral;
 ...
 * @author enzun
 */
public class GestionDisenoConsultaGeneral extends javax.swing.JFrame {

    /**
     * Creates new form FormDashboard
     */
    public GestionDisenoConsultaGeneral() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jPanel4.add(jLabel12, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 490, -1, -1));

        jLabel13.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        jLabel13.setIcon(new javax.swing.ImageIcon(getClass().getResource("/img/Reporte.png"))); // NOI18N
        ...
        jPanel4.add(jLabel13, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 490, -1, -1));
 ...
 try{
            ...
            String sql="SELECT idDiseno ,dimenciones ,bateria ,procesador ,pinCarga ,pinAudifono ,sistemaOperativo ,camaraFrontal ,camaraPosterior ,giroscopio ,acelerometro, detalles  FROM Diseno";
    ...
    private void jLabel13MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel13MouseClicked
        ...
        try {
            URL archivo=this.getClass().getResource("/Reportes/GeneralDiseno.jasper");
            ...
            Logger.getLogger(GestionDisenoConsultaGeneral.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionDisenoConsultaGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionDisenoConsultaGeneral().setVisible(true);
            }
        });
    }
