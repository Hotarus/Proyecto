...
import GestionProveedor.GestionProveedorConsultaGeneral;
 ...
 * @author enzun
 */
public class GestionSuministroConsultaGeneral extends javax.swing.JFrame {

    /**
     * Creates new form FormDashboard
     */
    public GestionSuministroConsultaGeneral() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jtbEnsamblador.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Suministro", "Nombre", "Bodega", "Ubicacion", "Descripcion", "Tipo"
            }
        ) {
 ...
 try{
            ...
            String sql="SELECT codigosuministro, nombre, bodega, ubicacion, descripcion, tipo FROM Suministro";
    ...
    private void jLabel18MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel18MouseClicked
        ...
        try {
            URL archivo=this.getClass().getResource("/Reportes/GeneralSuministro.jasper");
            ...
            Logger.getLogger(GestionSuministroConsultaGeneral.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GestionSuministroConsultaGeneral.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GestionSuministroConsultaGeneral().setVisible(true);
            }
        });
    }
